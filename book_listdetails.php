				...
				<div class="content">
                    ...
                    if($run->num_rows > 0){
                        ...
                        <tr>
                            ...
                            <a href="update_payment.php?payment_id=<?php echo $result["payment_id"]?>" class="btn btn-primary">Update Payment</a>
                            <?php
                    ...
                    <div>
                        <a href="pdf.php?guest_id=<?php echo $id ?>" class="btn btn-dark"target="_blank">Print</a>
                    </div>
